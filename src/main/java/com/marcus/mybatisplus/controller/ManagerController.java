...
import com.marcus.mybatisplus.mapper.ManagerMapper;
...
@Api(value = "manager接口",description="manager服务API根目录")
@RestController
public class ManagerController {
    ...
    public Manager insert(@RequestParam(value = "Operator", required = false) String Operator,
        ...
        manager.setDateTime(date_time);
        manager.setTaskInfo("["+task_info+"]");
        manager.setCheckInfo("["+check_info+"]");
